  ...
  Widget build(BuildContext context) {
    return Consumer<AppReviewProvider>(
      builder: (context, app, _) {
        final featured = app.products.take(3).toList();
          ...
          child: app.products.isEmpty
              ...
              : ListView(
                  ...
                  children: [
                    SurfaceCard(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(colors: [Color(0xFF2469EB), Color(0xFF103FBA)]),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Padding(
                          padding: const EdgeInsets.all(24),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('Discover trusted reviews before you buy',
                                style: Theme.of(context).textTheme.headlineMedium?.copyWith(color: Colors.white, fontWeight: FontWeight.w900)),
                            const SizedBox(height: 12),
                            const Text('Browse products, explore ratings, upload review photos, and manage your profile from anywhere in the app.',
                            ...
                            Wrap(spacing: 12, runSpacing: 12, children: [
                              ...
                              OutlinedButton(
                                onPressed: () => Navigator.pushNamed(context, app.isLoggedIn ? AppRoutes.profile : AppRoutes.signUp),
                    ...
                    Text('Featured Products', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w800)),
                    const SizedBox(height: 12),
                      ...
                      child: SurfaceCard(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text('${product.category} • ${product.brand}', style: const TextStyle(color: AppColors.textMuted)),
                          ])),
                          FilledButton(
